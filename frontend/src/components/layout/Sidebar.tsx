...
export function Sidebar() {
  ...
  return (
    <div className={cn(
      "flex flex-col border-r border-blue-100 bg-white transition-all duration-300 ease-in-out",
      expanded ? "w-64" : "w-20"
    )}>
      {/* Sidebar Header */}
      <div className="p-4 border-b border-blue-100 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          {expanded && <span className="text-xl font-bold text-blue-600">Admin</span>}
        </div>
        <Button
          variant="ghost"
          size="icon"
        ...
        {user ? (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-white border-blue-100 shadow-md rounded-md">
              {user.role === 'admin' && (
                <DropdownMenuItem onClick={() => navigate('/admin/metadata')} className="text-gray-700 hover:bg-blue-50 hover:text-blue-600">
