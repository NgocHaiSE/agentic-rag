...
import IngestSummary from '@/components/admin/ingest/IngestSummary'
import IngestFilters from '@/components/admin/ingest/IngestFilters'
import IngestTable from '@/components/admin/ingest/IngestTable'
import IngestDetailDialog from '@/components/admin/ingest/IngestDetailDialog'
